...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 3 \
    name conv_bias_buf_V \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename conv_bias_buf_V \
    op interface \
    ports { conv_bias_buf_V_address0 { O 7 vector } conv_bias_buf_V_ce0 { O 1 bit } conv_bias_buf_V_we0 { O 1 bit } conv_bias_buf_V_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv_bias_buf_V'"
}
}
