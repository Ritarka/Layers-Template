dict set slaves control {ports {input_feature_map {type i_ap_none width 64} layer_weights {type i_ap_none width 64} layer_bias {type i_ap_none width 64} output_feature_map {type i_ap_none width 64} ap_start {type ap_ctrl width 1} ap_done {type ap_ctrl width 1} ap_ready {type ap_ctrl width 1} ap_idle {type ap_ctrl width 1}} mems {} has_ctrl 1}
set datawidth 32
set addrwidth 64
