...
extern "C" void layer_top(short*, short*, int, int, int, int);
extern "C" void apatb_layer_top_hw(volatile void * __xlx_apatb_param_input_feature_map, volatile void * __xlx_apatb_param_layer_weights, volatile void * __xlx_apatb_param_layer_bias, volatile void * __xlx_apatb_param_output_feature_map) {
  ...
  int __xlx_size_param_output_feature_map = 1884160;
  ...
  int __xlx_size_param_layer_weights = 65536;
  ...
  int __xlx_size_param_layer_bias = 128;
  int __xlx_offset_param_layer_bias = 65536;
  int __xlx_offset_byte_param_layer_bias = 65536*2;
  ...
  // DUT call
  layer_top(__xlx_input_feature_map_output_feature_map__input_buffer, __xlx_layer_weights_layer_bias__input_buffer, __xlx_offset_byte_param_input_feature_map, __xlx_offset_byte_param_layer_weights, __xlx_offset_byte_param_layer_bias, __xlx_offset_byte_param_output_feature_map);
