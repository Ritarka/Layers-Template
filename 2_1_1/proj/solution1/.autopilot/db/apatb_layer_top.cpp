...
#define AUTOTB_TVIN_layer_weights "../tv/cdatafile/c.layer_top.autotvin_layer_weights.dat"
#define AUTOTB_TVOUT_layer_weights "../tv/cdatafile/c.layer_top.autotvout_layer_weights.dat"
#define AUTOTB_TVIN_layer_bias "../tv/cdatafile/c.layer_top.autotvin_layer_bias.dat"
#define AUTOTB_TVOUT_layer_bias "../tv/cdatafile/c.layer_top.autotvout_layer_bias.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_feature_map "../tv/rtldatafile/rtl.layer_top.autotvout_input_feature_map.dat"
#define AUTOTB_TVOUT_PC_layer_weights "../tv/rtldatafile/rtl.layer_top.autotvout_layer_weights.dat"
#define AUTOTB_TVOUT_PC_layer_bias "../tv/rtldatafile/rtl.layer_top.autotvout_layer_bias.dat"
#define AUTOTB_TVOUT_PC_output_feature_map "../tv/rtldatafile/rtl.layer_top.autotvout_output_feature_map.dat"
...
extern "C" void layer_top_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_layer_top_hw(volatile void * __xlx_apatb_param_input_feature_map, volatile void * __xlx_apatb_param_layer_weights, volatile void * __xlx_apatb_param_layer_bias, volatile void * __xlx_apatb_param_output_feature_map) {
...
{
transaction<16> tr(9420800);
aesl_fh.read(AUTOTB_TVOUT_PC_fm, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_input_feature_map, 7536640, 0);
tr.send<2>((char*)__xlx_apatb_param_output_feature_map, 1884160, 7536640);
}
#else
try {
...
if (__xlx_apatb_param_input_feature_map) {
  tr.import<2>((char*)__xlx_apatb_param_input_feature_map, 7536640, 0);
}
__xlx_offset_byte_param_output_feature_map = 7536640*2;
if (__xlx_apatb_param_output_feature_map) {
  tr.import<2>((char*)__xlx_apatb_param_output_feature_map, 1884160, 0);
}
aesl_fh.write(AUTOTB_TVIN_fm, tr.p, tr.tbytes);
tcl_file.set_num(9420800, &tcl_file.fm_depth);
}
#else
...
transaction<16> tr(65664);
__xlx_offset_byte_param_layer_weights = 0*2;
if (__xlx_apatb_param_layer_weights) {
  tr.import<2>((char*)__xlx_apatb_param_layer_weights, 65536, 0);
}
__xlx_offset_byte_param_layer_bias = 65536*2;
if (__xlx_apatb_param_layer_bias) {
  tr.import<2>((char*)__xlx_apatb_param_layer_bias, 128, 0);
}
aesl_fh.write(AUTOTB_TVIN_wt, tr.p, tr.tbytes);
tcl_file.set_num(65664, &tcl_file.wt_depth);
}
#else
...
layer_top_hw_stub_wrapper(__xlx_apatb_param_input_feature_map, __xlx_apatb_param_layer_weights, __xlx_apatb_param_layer_bias, __xlx_apatb_param_output_feature_map);
