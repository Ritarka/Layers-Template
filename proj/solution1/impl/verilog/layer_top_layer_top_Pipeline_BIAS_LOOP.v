...
module layer_top_layer_top_Pipeline_BIAS_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] f_1_reg_124_pp0_iter1_reg;
reg   [15:0] wt_addr_read_reg_138;
wire   [63:0] f_cast_fu_113_p1;
reg   [7:0] f_fu_50;
wire   [7:0] add_ln89_fu_102_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_f_1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln89_fu_96_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln89_fu_96_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln89_fu_102_p2 = (ap_sig_allocacmp_f_1 + 8'd1);
...
assign conv_bias_buf_V_address0 = f_cast_fu_113_p1;

assign conv_bias_buf_V_d0 = wt_addr_read_reg_138;

assign f_cast_fu_113_p1 = f_1_reg_124_pp0_iter1_reg;

assign icmp_ln89_fu_96_p2 = ((ap_sig_allocacmp_f_1 == 8'd128) ? 1'b1 : 1'b0);
...
endmodule //layer_top_layer_top_Pipeline_BIAS_LOOP
