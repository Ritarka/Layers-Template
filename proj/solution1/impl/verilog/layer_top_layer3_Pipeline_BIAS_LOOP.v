...
module layer_top_layer3_Pipeline_BIAS_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [62:0] sext_ln90;
output  [8:0] conv_bias_buf_V_address0;
output   conv_bias_buf_V_ce0;
output   conv_bias_buf_V_we0;
output  [15:0] conv_bias_buf_V_d0;
...
reg   [9:0] f_2_reg_122_pp0_iter1_reg;
reg   [15:0] wt_addr_read_reg_136;
wire   [63:0] f_cast_fu_111_p1;
reg   [9:0] f_fu_48;
wire   [9:0] add_ln90_fu_100_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_f_2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln90_fu_94_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln90_fu_94_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln90_fu_100_p2 = (ap_sig_allocacmp_f_2 + 10'd1);
...
assign conv_bias_buf_V_address0 = f_cast_fu_111_p1;

assign conv_bias_buf_V_d0 = wt_addr_read_reg_136;

assign f_cast_fu_111_p1 = f_2_reg_122_pp0_iter1_reg;

assign icmp_ln90_fu_94_p2 = ((ap_sig_allocacmp_f_2 == 10'd512) ? 1'b1 : 1'b0);
...
endmodule //layer_top_layer3_Pipeline_BIAS_LOOP
