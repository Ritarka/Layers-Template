...
module layer_top_layer2_Pipeline_BIAS_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [6:0] conv_bias_buf_V_address0;
...
reg   [7:0] f_3_reg_122_pp0_iter1_reg;
reg   [15:0] wt_addr_read_reg_136;
wire   [63:0] f_cast_fu_111_p1;
reg   [7:0] f_fu_48;
wire   [7:0] add_ln90_fu_100_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_f_3;
reg    ap_done_reg;
...
assign add_ln90_fu_100_p2 = (ap_sig_allocacmp_f_3 + 8'd1);
...
assign f_cast_fu_111_p1 = f_3_reg_122_pp0_iter1_reg;

assign icmp_ln90_fu_94_p2 = ((ap_sig_allocacmp_f_3 == 8'd128) ? 1'b1 : 1'b0);
...
endmodule //layer_top_layer2_Pipeline_BIAS_LOOP
