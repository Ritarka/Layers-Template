...
entity layer_top_layer3_Pipeline_BIAS_LOOP is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    conv_bias_buf_V_address0 : OUT STD_LOGIC_VECTOR (8 downto 0);
...
architecture behav of layer_top_layer3_Pipeline_BIAS_LOOP is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln90_fu_94_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal wt_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal f_2_reg_122 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal f_2_reg_122_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    signal wt_addr_read_reg_136 : STD_LOGIC_VECTOR (15 downto 0);
    signal f_cast_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal f_fu_48 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln90_fu_100_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_f_2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    f_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln90_fu_94_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    f_fu_48 <= add_ln90_fu_100_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    f_fu_48 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                f_2_reg_122 <= ap_sig_allocacmp_f_2;
                f_2_reg_122_pp0_iter1_reg <= f_2_reg_122;
                wt_addr_read_reg_136 <= m_axi_wt_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln90_fu_100_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_f_2) + unsigned(ap_const_lv10_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln90_fu_94_p2)
    begin
        if (((icmp_ln90_fu_94_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_f_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, f_fu_48, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_f_2 <= ap_const_lv10_0;
        else 
            ap_sig_allocacmp_f_2 <= f_fu_48;
        end if; 
    end process;

    conv_bias_buf_V_address0 <= f_cast_fu_111_p1(9 - 1 downto 0);

    conv_bias_buf_V_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    conv_bias_buf_V_d0 <= wt_addr_read_reg_136;

    conv_bias_buf_V_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            conv_bias_buf_V_we0 <= ap_const_logic_1;
        else 
            conv_bias_buf_V_we0 <= ap_const_logic_0;
        end if; 
    end process;

    f_cast_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(f_2_reg_122_pp0_iter1_reg),64));
    icmp_ln90_fu_94_p2 <= "1" when (ap_sig_allocacmp_f_2 = ap_const_lv10_200) else "0";
