...
entity layer_top_layer2_Pipeline_WEIGHT_KERNEL_HEIGHT_WEIGHT_KERNEL_WIDTH is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    conv_wt_buf_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
    conv_wt_buf_ce0 : OUT STD_LOGIC;
    conv_wt_buf_we0 : OUT STD_LOGIC;
    conv_wt_buf_d0 : OUT STD_LOGIC_VECTOR (15 downto 0) );
end;


architecture behav of layer_top_layer2_Pipeline_WEIGHT_KERNEL_HEIGHT_WEIGHT_KERNEL_WIDTH is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln73_fu_122_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal wt_addr_read_reg_252 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln78_2_fu_201_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal kw_fu_58 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln76_fu_206_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal kh_fu_62 : STD_LOGIC_VECTOR (1 downto 0);
    signal select_ln73_1_fu_165_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal indvar_flatten492_fu_66 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln73_1_fu_128_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_sig_allocacmp_indvar_flatten492_load : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln76_fu_151_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln73_fu_145_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_s_fu_177_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln78_fu_173_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln73_fu_157_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal sub_ln78_fu_185_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln78_1_fu_191_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln78_fu_195_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    indvar_flatten492_fu_66_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln73_fu_122_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    indvar_flatten492_fu_66 <= add_ln73_1_fu_128_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten492_fu_66 <= ap_const_lv4_0;
                end if;
            end if; 
        end if;
    end process;

    kh_fu_62_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    kh_fu_62 <= ap_const_lv2_0;
    ...
    kw_fu_58_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    kw_fu_58 <= ap_const_lv2_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
    ...
    add_ln73_1_fu_128_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten492_load) + unsigned(ap_const_lv4_1));
    add_ln73_fu_145_p2 <= std_logic_vector(unsigned(kh_fu_62) + unsigned(ap_const_lv2_1));
    add_ln76_fu_206_p2 <= std_logic_vector(unsigned(select_ln73_fu_157_p3) + unsigned(ap_const_lv2_1));
    add_ln78_fu_195_p2 <= std_logic_vector(unsigned(sub_ln78_fu_185_p2) + unsigned(zext_ln78_1_fu_191_p1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln73_fu_122_p2)
    begin
        if (((icmp_ln73_fu_122_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_indvar_flatten492_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, indvar_flatten492_fu_66)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_indvar_flatten492_load <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_indvar_flatten492_load <= indvar_flatten492_fu_66;
        end if; 
    end process;

    conv_wt_buf_address0 <= zext_ln78_2_fu_201_p1(4 - 1 downto 0);

    conv_wt_buf_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            conv_wt_buf_ce0 <= ap_const_logic_1;
        else 
            conv_wt_buf_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    conv_wt_buf_d0 <= wt_addr_read_reg_252;

    conv_wt_buf_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            conv_wt_buf_we0 <= ap_const_logic_1;
        else 
            conv_wt_buf_we0 <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln73_fu_122_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten492_load = ap_const_lv4_9) else "0";
    icmp_ln76_fu_151_p2 <= "1" when (kw_fu_58 = ap_const_lv2_3) else "0";
    ...
    select_ln73_1_fu_165_p3 <= 
        add_ln73_fu_145_p2 when (icmp_ln76_fu_151_p2(0) = '1') else 
        kh_fu_62;
    select_ln73_fu_157_p3 <= 
        ap_const_lv2_0 when (icmp_ln76_fu_151_p2(0) = '1') else 
        kw_fu_58;
    sub_ln78_fu_185_p2 <= std_logic_vector(unsigned(tmp_s_fu_177_p3) - unsigned(zext_ln78_fu_173_p1));
    tmp_s_fu_177_p3 <= (select_ln73_1_fu_165_p3 & ap_const_lv2_0);
    ...
    zext_ln78_1_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln73_fu_157_p3),4));
    zext_ln78_2_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln78_fu_195_p2),64));
    zext_ln78_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln73_1_fu_165_p3),4));
end behav;
