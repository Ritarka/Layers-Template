...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename conv_bias_buf \
    op interface \
    ports { conv_bias_buf_address0 { O 9 vector } conv_bias_buf_ce0 { O 1 bit } conv_bias_buf_we0 { O 1 bit } conv_bias_buf_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv_bias_buf'"
}
}
