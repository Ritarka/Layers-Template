...
set id 2618
set name layer_top_mac_muladd_10ns_14ns_12ns_23_4_1
...
set ce_signed 0
set out_width 23
set arg_lists {i0 {10 0 +} i1 {14 0 +} m {23 1 +} i2 {12 0 +} p {23 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
